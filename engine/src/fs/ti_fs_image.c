...
void fs_image_load(fs_image_t *image, fs_file *file) {
  ...
  fs_file_read(file, &image->format_index, sizeof(uint64_t), 0);
  fs_file_read(file, &image->image_layout_index, sizeof(uint64_t), 0);
  fs_file_read(file, &image->image_type_index, sizeof(uint64_t), 0);
  fs_file_read(file, &image->image_tiling_index, sizeof(uint64_t), 0);
  fs_file_read(file, &image->image_view_type_index, sizeof(uint64_t), 0);
...
void fs_image_store(fs_image_t *image, fs_file *file) {
  ...
  fs_file_write(file, &image->format_index, sizeof(uint64_t), 0);
  fs_file_write(file, &image->image_layout_index, sizeof(uint64_t), 0);
  fs_file_write(file, &image->image_type_index, sizeof(uint64_t), 0);
  fs_file_write(file, &image->image_tiling_index, sizeof(uint64_t), 0);
  fs_file_write(file, &image->image_view_type_index, sizeof(uint64_t), 0);
